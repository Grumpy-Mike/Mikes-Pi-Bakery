# Mains control 8 - Hunt the Snark limited to 8 controllers
...
screen = pygame.display.set_mode([525,480],0,32)
textHeight = 22
...
groupPins = [17,17,17,17, 23,23,23,23]
channelPins = [4, 18, 22, 24, 4, 18, 22, 24]
A_11Pin = 25
sendPin = 9
...
def togglePlug(click):
   global plugState
   plug = (click[0] / 130) + (4 *(click[1] /240))
...
def huntSet():
   ...
   changed = False
   maxiumChanges = 4 # alter for more potential changes
   while not(changed):
...
def terminate(): # close down the program
    ...
    for plug in range(0,8): # Turn all plugs off - delete if required
