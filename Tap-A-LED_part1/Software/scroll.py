#!/usr/bin/env python3
# Scroll text by Mike Cook August 2020

import board
import neopixel
import time

textCol = (128, 0, 0) # colour for text
backCol = (0, 16, 16)  # colour for background

def main():
    init()
    displayText("Tap-A-LED ") # change to what you want to show, end with a space
