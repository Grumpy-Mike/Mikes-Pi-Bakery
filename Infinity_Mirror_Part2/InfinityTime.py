...
try :
   io.wiringPiSetup() # the wiring Pi pin mode
except :
...
sensorPins = [0,5,4,2] # these have to be in the WPI mode
shutDownPin = 25  # this have to be in the WPI mode
